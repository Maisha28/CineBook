...
// Fires N threads at the same seat at (roughly) the same instant, to make
// the double-booking race condition observable -- and, once bookSeat() is
// synchronized, to show it go away.
